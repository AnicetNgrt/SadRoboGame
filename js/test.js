...
var saveSight; var verou2; var aimLengh = 0.07; var angle;
...
var menuBlue; var menuRed; var cr;
...
var saveSight2; var verou22; var aimLengh2 = 0.07; var angle2;
var droiteA2; var droiteB2; var sight2; var player2;
var facing2 = 'left'; var jumpTimer2 = 0; var aim2X = 30;
var jumpButton2; var wasLeft2; var wasRight2;
...
var hitSnd; var menuIndex = 1;
var life2 = 10; var heartTime;
var stepId2 = 1;
...
var snd4; var verou8 = true;
var bruh; var aimReset = 0; var aimReset2 = 0;
var bruh2; var text; var text2;
...
function mooveOK2 () {
  ...
  if (jjjj.isDown || pad2.axis(Phaser.Gamepad.XBOX360_STICK_LEFT_X) < -0.1)
  {
  ...
  else if (llll.isDown || pad2.axis(Phaser.Gamepad.XBOX360_STICK_LEFT_X) > 0.1)
  {
      yolo2 = true;
      player2.body.velocity.x = 50;
  ...
  if ((iiii.isDown || pad2.justPressed(Phaser.Gamepad.XBOX360_RIGHT_TRIGGER)) && player2.body.onFloor() && game.time.now > jumpTimer2 && player2.body.velocity.x != 0)
  {
      yolo2 = true;
...
function shooting2 () {
  if (jumpButton2.isDown || pad2.isDown(Phaser.Gamepad.XBOX360_LEFT_TRIGGER)) {
