...
function preload() {
    ...
    game.load.image('fond', 'assets/BACKGROUND AND TILES/fond.png');
}
...
var randomizer3; var alpha2; var omega2; var fond;
...
function choixIa() {
  choixMax = 2;
  text4.setText("                    Disable/enable AI")
  switch (choixIndex) {
    case 1:
      text3.setText("      enabled");
      text3.stroke = '#980000';
      isIa = true;
      break;
    case 2:
...
function AIlevel() {
  choixMax = 5;
  text4.setText("             AI's Level (let it like it is if you disabled it)")
  switch (choixIndex) {
    case 1:
      text3.setText("         noob");
      text3.stroke = '#1a6f00';
